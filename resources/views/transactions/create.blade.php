                        ...
                        <div>
                            ...
                            <div class="flex gap-4">
                                <label class="flex items-center">
                                    <input type="radio" name="type" value="income" class="text-green-600 focus:ring-green-500" {{ old('type') == 'income' ? 'checked' : '' }}>
                                    <span class="ml-2 text-green-600 font-medium">Receita</span>
                                </label>
                                <label class="flex items-center">
                                    <input type="radio" name="type" value="expense" class="text-red-600 focus:ring-red-500" {{ old('type') == 'expense' ? 'checked' : '' }}>
